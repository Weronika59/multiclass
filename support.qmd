...
no_failure <- df_train_trans |> 
  filter(death == 0, hospdead == 0, sfdm2 == 1) |> 
  slice_sample(n = 500) 

dt_to_smote <- df_train_trans |> 
  filter(death == 1 | hospdead == 1 | sfdm2 == 2 | sfdm2 == 3 | sfdm2 == 4 | sfdm2 == 5) |>
  select(PC1, PC2, PC3, PC4, PC5, sex_X1, dzgroup_X2, dzgroup_X3, dzgroup_X4, dzgroup_X5, dzgroup_X6, dzgroup_X7, dzgroup_X8, dzclass_X2, dzclass_X3, dzclass_X4, ca_X1, ca_X2, income_X2, income_X3, income_X4, race_X2, race_X3, race_X4, race_X5, dnr_X1, dnr_X2, diabetes_X1, dementia_X1, everything()) 
...
```{r}
ds_smote <- MLSMOTE(D = ds, k = 5) #chyba bez VDM powinno być, ale nie działa bez niego
